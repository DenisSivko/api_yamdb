# Generated by Django 2.2.6 on 2021-07-17 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(blank=True, db_index=True, validators=[django.core.validators.MaxValueValidator(2021)], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.Title', verbose_name='Произведение')),
            ],
            options={
